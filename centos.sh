...
sudo kubeadm init --pod-network-cidr=10.244.0.0/16 --upload-certs --kubernetes-version=v1.26.1 –control-plane-endpoint=192.168.56.200 --cri-socket unix:///run/containerd/containerd.sock
------
